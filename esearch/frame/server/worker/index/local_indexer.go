...
import (
	...
	"encoding/gob"
	"fmt"
	kvDb "framework/frame/server/worker/kv"
	types "framework/frame/util_types"
...
type LocalIndexer struct {
	...
	reverseIndex types.InvertedIndexer // 倒排索引实例
...
func (indexer *LocalIndexer) Init(docNumEstimate, dbType int, dataDir string) error {
	...
	// 初始化倒排索引
	indexer.reverseIndex = types.NewSkipListInvertedIndexer(docNumEstimate)
