...
type Document struct {
	...
	BitsFeatures uint64     `protobuf:"varint,3,opt,name=BitsFeatures,proto3" json:"BitsFeatures,omitempty"`
...
func (m *Document) GetBitsFeatures() uint64 {
	if m != nil {
		return m.BitsFeatures
	}
	return 0
}
...
var fileDescriptor_37cb16cf10c66117 = []byte{
	...
	,
}
...
func (m *Document) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BitsFeatures != 0 {
		i = encodeVarintDoc(dAtA, i, uint64(m.BitsFeatures))
		i--
		dAtA[i] = 0x18
	}
	if m.IntId != 0 {
...
func (m *Document) Size() (n int) {
	...
	if m.BitsFeatures != 0 {
		n += 1 + sovDoc(uint64(m.BitsFeatures))
	}
	if len(m.Keywords) > 0 {
...
func (m *Document) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BitsFeatures", wireType)
			}
			m.BitsFeatures = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BitsFeatures |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
